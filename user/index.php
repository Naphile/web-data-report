                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										 Selamat datang di dashboard sistem pelaporan Witel Makassar.
                                         <br><br>
                                         Panduan Pelaporan:
                                         <br>1. Pada bagian menu, klik 'Pelaporan'.
                                         <br>2. Isi seluruh data yang ditampilkan kemudian periksa kembali, pastikan tidak ada data yang salah sebelum klik "Submit".
                                         <br>3. Klik Submit, kemudian klik Confirm.
                                         <br>
