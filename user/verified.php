                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive" style="font-style: italic;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="file-mancore" type="text" class="form-control" value="Verified" style="font-style: italic;" disabled>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="file-kml" type="text" class="form-control" value="Verified" style="font-style: italic;" disabled>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>File APD*</label>
                                                        <input name="file-apd" type="text" class="form-control" value="Verified" style="font-style: italic;" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
