...
<head>
    ...
    <title>Telkom Report System: View Data Report</title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="form.php"><i class="ti-layout"></i><span>Data Report</span></a>
                            </li>
                            <li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h2><?php echo $ambil['namamitra'] ?></h2>
                                </div>
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <img src="../user/<?php echo $ambil['fotoqr'] ?>" width="20%">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="market-status-table mt-4">
                                        <div class="table-responsive" style="overflow-x:hidden;">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <img src="../user/<?php echo $ambil['fotoep'] ?>" width="100%">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label for="fotoqr" class=" form-control-label">Foto Validasi (QR)</label><br>
                                                        <img src="../user/<?php echo $ambil['fotoqr'] ?>" width="50%">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- <div class="modal-footer">
                                                <a href="report.php" class="btn btn-primary">Lihat File Pelaporan</a>
                                            </div> -->
